...
def evaluate_mpl(data: dict, curve_set: list, best_params: list, fig_folder: str, title = None):
    """
    ...
    for file_name in curve_set:
        ...
        if title is not None: plt.suptitle(title) # 增加代码，显示 title
        plt.legend()
